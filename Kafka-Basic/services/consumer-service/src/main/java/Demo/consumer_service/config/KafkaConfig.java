package Demo.consumer_service.config;
...
public class KafkaConfig {
    ...
    public ConsumerFactory<String, MessageRequest> consumerFactory() {
        ...
        config.put(ConsumerConfig.GROUP_ID_CONFIG, "lab-group");
        config.put(ConsumerConfig.KEY_DESERIALIZER_CLASS_CONFIG, StringDeserializer.class);
        config.put(ConsumerConfig.VALUE_DESERIALIZER_CLASS_CONFIG, JsonDeserializer.class);
        config.put(JsonDeserializer.TRUSTED_PACKAGES, "*");
        return new DefaultKafkaConsumerFactory<>(config, new StringDeserializer(), new JsonDeserializer<>(MessageRequest.class));
    }
